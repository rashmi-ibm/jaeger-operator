...
func AddFlags(cmd *cobra.Command) {
	...
	cmd.Flags().String("jaeger-agent-image", "quay.io/maistra/jaeger-agent-rhel7:1.17.6-ibm", "The Docker image for the Jaeger Agent")
	cmd.Flags().String("jaeger-query-image", "quay.io/maistra/jaeger-query-rhel7:1.17.6-ibm", "The Docker image for the Jaeger Query")
	cmd.Flags().String("jaeger-collector-image", "quay.io/maistra/jaeger-collector-rhel7:1.17.6-ibm", "The Docker image for the Jaeger Collector")
	cmd.Flags().String("jaeger-ingester-image", "quay.io/maistra/jaeger-ingester-rhel7:1.17.6-ibm", "The Docker image for the Jaeger Ingester")
	cmd.Flags().String("jaeger-all-in-one-image", "quay.io/maistra/jaeger-all-in-one-rhel7:1.17.6-ibm", "The Docker image for the Jaeger all-in-one")
	...
	cmd.Flags().String("jaeger-es-index-cleaner-image", "quay.io/maistra/jaeger-es-index-cleaner-rhel7:1.17.6-ibm", "The Docker image for the Jaeger Elasticsearch Index Cleaner")
